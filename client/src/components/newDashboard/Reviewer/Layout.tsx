...
export default function ReviewerLayout({ children }: { children?: React.ReactNode }) {
  ...
  useEffect(() => {
    if(id){
      setCurrentPathName("Review Form")
    } 
    else if(location.pathname === "/reviewer-dashboard"){
      setCurrentPathName("Home")
    }
    else if(location.pathname === "/reviewer-dashboard/assess-papers"){
      setCurrentPathName("Assess Papers")
    }
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>Reviewer Dashboard / {currentPathName}</div>
